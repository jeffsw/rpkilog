...
class VrpDiff():
    ...
    def cli_entry_point(cls):
        # TODO: this can be refactored.  It isn't setup as a CLI entry point right now.  See other TODOs.
        ...
        if 'new_file_key' in args:
            # TODO: Don't necessarily need this.  It expects the old file to be in S3 but new file locally.
            metadata = cls.generic_entry_point(
            ...
            # TODO: This is the minimum functionality we need for testing & verification with local files
            ...
            # TODO: Don't need this anymore.  rpkilog-diff-import entry point has more sophistication
            #       and that's what we really use to catch up the DB when it's missed something.
